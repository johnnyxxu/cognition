...
module.exports = function(conf) {
  ...
  var pubDir = path.join(conf.paths.cog_root, 'web', 'public');
  var resourceDir = path.join(conf.paths.cog_root, 'web', 'resources');
  var routesDir = path.join(conf.paths.cog_root, 'lib', 'routes');
